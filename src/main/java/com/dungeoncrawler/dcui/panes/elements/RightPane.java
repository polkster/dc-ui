...
public class RightPane extends Pane2D {
	...
	protected void loadResources() {
		...
		Entity2D slingshot = new Entity2D(32, 32, Utility.loadImage( RESOURCE_SLINGSHOT) );
		Entity2D sword = new Entity2D(32, 32, Utility.loadImage( RESOURCE_SWORD ) );
		Entity2D mace = new Entity2D(32, 32, Utility.loadImage( RESOURCE_MACE ) );
		Entity2D bow = new Entity2D(32, 32, Utility.loadImage( RESOURCE_BOW) );
